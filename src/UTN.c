 ...
 * \param pResult: es la direccn de memoria (variable) donde guardar  el número ingresado.
 * \param message: Texto informativo al momento de solicitar un valor al usuario.
 * \param errorMessage: Texto que se mostrar en caso de un rango de númers invalido.
